...
\begin{figure}[t]%[H]%[!htbp]
  ...
  \caption{\finalhyphendemerits=1000
           Equivalent planform of the wing assigned in the exercise \ref{example:Equivalent:Plan:Form:Of:A:Cranked:Wing}.
  }
  \label{fig:Cranked:Wing:Planform:Results:B}%
\end{figure}
%
\input{Chapter_2/equivalent_plan_form_of_a_cranked_wing/data}
%
