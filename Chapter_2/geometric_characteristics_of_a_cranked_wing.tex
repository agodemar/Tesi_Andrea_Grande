...
and $\Lambda_\mathrm{le,2}=\SI[round-precision=1]{\mySweepLEWingIIDEG}{\deg}$.
...
\]
being the two integrals on the second side equal to $S_1 \, \bar{c}_1$ and $S_2 \, \bar{c}_2$, respectively, we have that $\bar{c}$ of the given wing is given by the following weighted average:
\[
...
\begin{figure}[t]%[H]%[!htbp]
  ...
  \caption{\finalhyphendemerits=1000
         ...
         It is also reported the piecewise linear chord law .
  }
