...
\begin{figure}[t]%[H]%[!htbp]
  ...
  \caption{\finalhyphendemerits=1000
           Forma in pianta assegnata nell'esempio~\ref{example:Geometric:Characteristics:Of:A:Cranked:Wing}.}
  \label{fig:Cranked:Wing}%
\end{figure}
%
\input{Chapter_2/geometric_characteristics_of_a_cranked_wing/data}
%
...
%
\noindent
A wing with a finished wingspan has the leading and trailing edges corresponding to two segments. In particular, the plan shape of the right wing is the union of two panels labeled as " panel ~ 1 " (inner panel) and " panel ~ 2 " (outer panel),
This type of plan shape is also called \emph{cranked wing}.
...
\medskip
The chord law of this plan shape is the following piecewise linear function: 
\[
c(Y)=
\begin{cases}
%\left\{
...
The assigned plan shape has a total surface area equal to:
\[
S = S_1 + S_2
...
\begin{figure}[t]%[H]%[!htbp]
  ...
  \caption{\finalhyphendemerits=1000
           Forma in pianta dell'ala \emph{cranked} assegnata nell'esempio~\ref{example:Geometric:Characteristics:Of:A:Cranked:Wing}.
